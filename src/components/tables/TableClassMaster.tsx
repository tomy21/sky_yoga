...
import { useClassMaster, useDeleteClass } from '@/hooks/useClassMaster';
import { ClassMaster, Status } from '@prisma/client';
import Badge from '../ui/badge/Badge';
import { IoPencilOutline, IoTrashOutline } from 'react-icons/io5';
import { format } from 'date-fns';
import Pagination from './Pagination';
import Button from '../ui/button/Button';
import ClassFormModal from '../form/formadd/class';
import DeleteConfirmationModal from '../ui/modal/delete-confirmation';
import SuccessModal from '../ui/modal/success-modal';

export default function TableClassMaster() {
    const [search, setSearch] = useState("");
    const [currentPage, setCurrentPage] = useState(1);
    const [selectedLimit, setSelectedLimit] = useState<string>("10");
    const { data, isLoading, isError } = useClassMaster(currentPage, parseInt(selectedLimit),search);
    ...
    const classMasters: ClassMaster[] = data?.data || [];
