...
import { removeTokenCookie } from "@/app/api/lib/auth";
    ...
    if (typeof window !== "undefined") {
      ...
      if (user) {
        try {
          ...
          setFullname(userData.userDetail.fullName);
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
          <Image width={44} height={44} src="/images/user.png" alt="User" />
        </span>
        ...
        <div className="flex flex-col items-start justify-start">
          ...
          <span className="text-theme-xs mr-1 block font-light">{role}</span>
        </div>
